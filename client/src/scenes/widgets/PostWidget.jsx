...
//       // Remove the post from the Redux store by dispatching the deletePost action
//       dispatch(deletePost(selectedPostId));

//       // You can also perform any other necessary actions here after successful deletion
//       // For example, you can navigate to another page or show a notification
//     } catch (error) {
//       console.error(error);
//     }
//   };
